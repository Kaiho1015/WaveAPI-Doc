...
* `gpt-5-nano` - GPT-5 超輕量版
* `gpt-5.1` - GPT-5.1
* `gpt-5.2` - GPT-5.2
* `gpt-5.4` - GPT-5.4
* `gpt-4.1` - GPT-4.1
* `gpt-4.1-mini` - GPT-4.1 輕量版
* `gpt-4.1-nano` - GPT-4.1 超輕量版
* `gpt-4o` - GPT-4o 多模態模型
* `gpt-4o-mini` - GPT-4o 輕量版
* `o1` - OpenAI o1 推理模型
...
* `claude-opus-4.6` - Claude 4.6 Opus 最新旗艦模型
* `claude-sonnet-4.6` - Claude 4.6 Sonnet 最新版
* `claude-opus-4.5` - Claude 4.5 Opus 旗艦模型
* `claude-sonnet-4.5` - Claude 4.5 Sonnet 平衡版
* `claude-haiku-4.5` - Claude 4.5 Haiku 快速回應版
...
* `deepseek-v3.2-exp` - DeepSeek V3.2 實驗版
