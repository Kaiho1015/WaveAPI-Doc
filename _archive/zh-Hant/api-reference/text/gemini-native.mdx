...
| 特性 | Gemini 3.1 Pro | Gemini 3 Flash | Gemini 2.5 Pro | Gemini 2.5 Flash | Gemini 2.5 Flash Lite |
|------|---------------|----------------|----------------|------------------|-----------------------|
| 上下文視窗 | 100萬 tokens | 100萬 tokens | 100萬 tokens | 100萬 tokens | 100萬 tokens |
| 多模態輸入 | 可用 | 可用 | 可用 | 可用 | 可用 |
| 程式碼生成 | 可用 | 可用 | 可用 | 可用 | 可用 |
| 速度 | 快 | 極快 | 快 | 極快 | 極快 |
