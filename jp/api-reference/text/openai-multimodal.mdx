...
<RequestExample>
```bash cURL
curl -X POST https://ai.kaiho.cc/v1/responses \
...
func main() {
    ...
    req, _ := http.NewRequest("POST", "https://ai.kaiho.cc/v1/responses", bytes.NewBuffer(body))
...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder()
            .uri(URI.create("https://ai.kaiho.cc/v1/responses"))
