...
<ParamField body="model" type="string" required>
  ...
  * `gpt-5-pro` - GPT-5 professional enhanced version (this endpoint only)
  ...
  * Plus all models supported by `/v1/chat/completions`

  <Note>
  `gpt-5-pro` and all Codex series models are exclusive to this endpoint (`/v1/responses`) and are not supported by `/v1/chat/completions`.
  </Note>
</ParamField>
