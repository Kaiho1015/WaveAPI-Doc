...
| `veo-3.1-lite` | VEO 3.1 lite version, lower cost |
| `veo-3.1-quality` | VEO 3.1 quality version |
...
<Tabs>
  ...
  <Tab title="VEO 3.1 Lite">
    **resolution options:** `720p`, `1080p` (4K not supported)

    Lower cost lite version.
...
| Resolution `4k` | VEO 3.1 Fast and Quality only, Lite not supported |
