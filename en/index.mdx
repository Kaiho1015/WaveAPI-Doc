...
<Steps>
  <Step title="Get an API Key">
    Go to the [Dashboard](https://ai.kaiho.cc/dashboard/keys) to sign up and obtain your API key
  </Step>
  <Step title="Replace the Base URL">
    Replace the base URL in your OpenAI SDK with `https://ai.kaiho.cc/v1`
  </Step>
